...
import warehouseDeleveryOrders from 'features/warehousemanager/deleveryOrdersThunk';
...
const DeleveryOrders = () => {
  ...
  const deleveryOrders = useSelector((state) => state.warehouseOrders);
  let isLoading = deleveryOrders.loading;

  console.log(deleveryOrders);

  const dispatch = useDispatch();
  useEffect(() => {
    dispatch(
      warehouseDeleveryOrders({
        page,
        cardName,
        startDate,
        endDate,
  ...
  return (
    <div>
      <Heading>Delevery Orders</Heading>
      ...
      {isLoading ? (
        ...
        <TableContainer>
          <Table variant="striped" colorScheme="green">
            ...
            <Tbody>
              {deleveryOrders.data &&
                deleveryOrders.data.map((order, index) => (
                  <Tr
                    key={index}
                    cursor={'pointer'}
